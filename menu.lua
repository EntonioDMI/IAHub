return function(Modules)
    ...
    pcall(function() Modules.Aimbot(Fluent, Tabs.Aimbot) end)
    pcall(function() Modules.Hitboxes(Fluent, Tabs.Hitboxes) end)
    pcall(function() Modules.Highlight(Fluent, Tabs.Highlight) end)
    pcall(function() Modules.Misc(Fluent, Tabs.Misc) end)
